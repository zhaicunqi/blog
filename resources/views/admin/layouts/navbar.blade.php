		...
		<div class="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand">
					<small>
						<img src="{{URL::asset('')}}static/admin/assets/img/logo.png" alt="" />
					</small>
				</a>
			</div>
			<!-- /Navbar Barnd -->
					...
					<ul class="account-area">
						...
						<li>
							...
							<ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
								<li>
									<a href="#">
										<img src="{{URL::asset('')}}static/admin/assets/img/avatars/divyia.jpg" class="message-avatar" alt="Divyia Austin">
										<div class="message">
								...
								<li>
									<a href="#">
										<img src="{{URL::asset('')}}static/admin/assets/img/avatars/bing.png" class="message-avatar" alt="Microsoft Bing">
										<div class="message">
                                                <span class="message-sender">
                                                    Bing.com
                                                </span>
								...
								<li>
									<a href="#">
										<img src="{{URL::asset('')}}static/admin/assets/img/avatars/adam-jansen.jpg" class="message-avatar" alt="Divyia Austin">
										<div class="message">
                                                <span class="message-sender">
                                                    Nicolas
                                                </span>
						...
						<li>
							<a class="login-area dropdown-toggle" data-toggle="dropdown">
								<div class="avatar" title="View your public profile">
									<img src="{{URL::asset('')}}static/admin/assets/img/avatars/adam-jansen.jpg">
								</div>
								<section>
							...
							<ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
								...
								<li>
									<div class="avatar-area">
										<img src="{{URL::asset('')}}static/admin/assets/img/avatars/adam-jansen.jpg" class="avatar">
