										...
										<div id="visits" class="tab-pane active animated fadeInUp">
											<div class="row">
												<div class="col-lg-12 chart-container">
													<div id="dashboard-chart-visits" class="chart chart-lg no-margin" style="padding: 0px; position: relative;"><canvas class="flot-base" width="1750" height="500" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 875px; height: 250px;"></canvas><div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);"><div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 64px; text-align: center;">4</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 183px; text-align: center;">6</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 303px; text-align: center;">8</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 419px; text-align: center;">10</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 538px; text-align: center;">12</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 657px; text-align: center;">14</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 97px; top: 233px; left: 776px; text-align: center;">16</div></div></div><canvas class="flot-overlay" width="1750" height="500" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 875px; height: 250px;"></canvas></div>
												</div>
											</div>
														...
														<div class="databox-top">
															<div class="databox-piechart">
																<div data-toggle="easypiechart" class="easyPieChart block-center" data-barcolor="themeprimary" data-linecap="butt" data-percent="80" data-animate="500" data-linewidth="8" data-size="125" data-trackcolor="#eee" style="width: 125px; height: 125px; line-height: 125px;">
																	...
																	<canvas width="250" height="250" style="width: 125px; height: 125px;"></canvas></div>
															</div>
														</div>
														<div class="databox-bottom no-padding text-align-center">
					...
					<div class="databox-bottom">
						<div class="databox-row row-12">
							<div class="databox-cell cell-7 text-center  padding-5">
								<div id="dashboard-pie-chart-sources" class="chart" style="padding: 0px; position: relative;"><canvas class="flot-base" width="594" height="440" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 297px; height: 220px;"></canvas><canvas class="flot-overlay" width="594" height="440" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 297px; height: 220px;"></canvas></div>
							</div>
